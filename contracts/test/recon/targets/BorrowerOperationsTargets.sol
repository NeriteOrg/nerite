...
abstract contract BorrowerOperationsTargets is BaseTargetFunctions, Properties {
    ...
    function borrowerOperations_claimCollateral() public updateGhosts {
        ...
        eq(
            balAfter - balB4,
            currentSurplus,
            "An owner that claims collateral surplus always receives the exact amount they are owed"
        );
    }
    ...
    function borrowerOperations_adjustTrove(
        uint256 _troveId,
        uint256 _collChange,
    ...
    function borrowerOperations_adjustTrove_clamped(
        ...
        borrowerOperations_adjustTrove(
            clampedTroveId, _collChange, _isCollIncrease, _boldChange, _isDebtIncrease, type(uint256).max
        );
    }

    function borrowerOperations_adjustTroveInterestRate(
        uint256 _troveId,
        ...
        borrowerOperations.adjustTroveInterestRate(
            _troveId, _newAnnualInterestRate, _upperHint, _lowerHint, _maxUpfrontFee
        );
    }
    ...
    function borrowerOperations_adjustZombieTrove(
        uint256 _troveId,
        uint256 _collChange,
        bool _isCollIncrease,
        uint256 _boldChange,
    ...
    function borrowerOperations_adjustZombieTrove_clamped(
        ...
        borrowerOperations_adjustZombieTrove(
            clampedTroveId,
            collChange,
            _isCollIncrease,
            boldChange,
    ...
    function borrowerOperations_applyPendingDebt(uint256 _troveId, uint256 _lowerHint, uint256 _upperHint)
        public
        updateGhosts
        asActor
    {
    ...
    function borrowerOperations_openTrove(
        address _owner,
        uint256 _ownerIndex,
        uint256 _collAmount,
        uint256 _boldAmount,
        ...
        address _receiver
    ) public updateGhosts asActor returns (uint256) {
    ...
    function borrowerOperations_openTrove_clamped(
        ...
        return borrowerOperations_openTrove(
            _getActor(),
            _ownerIndex,
            _collAmount,
            _boldAmount,
    ...
    function borrowerOperations_openTroveAndJoinInterestBatchManager(
    ...
    function borrowerOperations_registerBatchManager(
    ...
    function borrowerOperations_removeFromBatch(
        uint256 _troveId,
        uint256 _newAnnualInterestRate,
        uint256 _upperHint,
        uint256 _lowerHint,
    ...
    function borrowerOperations_setBatchManagerAnnualInterestRate(
    ...
    function borrowerOperations_setBatchManagerAnnualInterestRate_clamped(uint128 _newAnnualInterestRate)
        public
        updateGhosts
    {
    ...
    function borrowerOperations_setInterestBatchManager(
        uint256 _troveId,
    ...
    function borrowerOperations_setInterestIndividualDelegate(
        uint256 _troveId,
        address _delegate,
        uint128 _minInterestRate,
        uint128 _maxInterestRate,
    ...
    function borrowerOperations_setRemoveManagerWithReceiver(uint256 _troveId, address _manager, address _receiver)
        public
        updateGhosts
        asActor
    {
    ...
    function borrowerOperations_switchBatchManager(
        uint256 _troveId,
    ...
    // === Withdraw Bold === //
    function borrowerOperations_withdrawBold(uint256 _troveId, uint256 _boldAmount, uint256 _maxUpfrontFee)
        public
        updateGhosts
        asActor
    {
