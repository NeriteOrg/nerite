...
abstract contract BeforeAfter is Setup {
    ...
    function __before() internal {
        ...
        for (uint256 i; i < troveArrayLength; i++) {
            ...
            ) = troveManager.getBatch(_getActor());
            ...
            _before.ghostWeightedRecordedDebtAccumulator +=
                (_before.dataForTroves[troveId].entireDebt * troveManager.getTroveInterestRate(troveId));
    ...
    function __after() internal {
        ...
        for (uint256 i; i < troveArrayLength; i++) {
            ...
            _after.ghostWeightedRecordedDebtAccumulator +=
                (_after.dataForTroves[troveId].entireDebt * troveManager.getTroveInterestRate(troveId));
