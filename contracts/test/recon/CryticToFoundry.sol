...
contract CryticToFoundry is Test, TargetFunctions, FoundryAsserts {
    ...
    function test_crytic() public {
        ...
        borrowerOperations_openTrove(
            address(this), 123, 100e18, 2000e18, 0, 0, 1e18, 100e18, address(this), address(this), address(this)
        );
        borrowerOperations_openTrove(
            address(this), 13232, 100e18, 2000e18, 0, 0, 1e18, 100e18, address(this), address(this), address(this)
        );
    ...
    function test_property_active_troves_are_above_MIN_DEBT_1() public {
        borrowerOperations_openTrove_clamped(
            ...
            0,
            13339564538247939756636,
            1996998175339557135783,
            0x0000000000000000000000000000000000000000,
            0x0000000000000000000000000000000000000000,
            0x0000000000000000000000000000000000000000
        );
    ...
    function test_optimize_ap01_under_0() public {
        ...
        borrowerOperations_openTrove_clamped(
            ...
            93701483398682665984728072936648256433854685342449288884605117331643986361215,
            79409241918338619357573071,
            260636221954315249937846958,
            0xc98D9175A32ca68C4B83dB84B4707AF82ae37cC4,
            0x0000000000000000000000000000000000000F08,
            0x00000000000000000000000000000002fFffFffD
        );
        ...
        stabilityPool_provideToSP_clamped(
            27424305496545741552056768792830585584317965363475532520705411256164270180376, false
        );
        ...
        borrowerOperations_adjustTroveInterestRate_clamped(
            64479505916471466477331997908391885217657807194625147020426390684972435426202,
            15398573290560247665990881735019176722007117505318547132077308618354371879859,
            2962310210599114012974028230312168185270655657574208074510281456716751689783
        );
